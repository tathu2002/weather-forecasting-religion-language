...
class WeatherApp(App):
    def build(self):
        ...
        # background_img = AsyncImage(source="https://www.google.com/url?sa=i&url=https%3A%2F%2Fstock.adobe.com%2Fsearch%3Fk%3D%2522weather%2Bbackground%2522&psig=AOvVaw0fPosqxsip6T5RoASRH0tW&ust=1710479729595000&source=images&cd=vfe&opi=89978449&ved=0CBMQjRxqFwoTCPCAh9z_8oQDFQAAAAAdAAAAABAK")  # Replace URL with your image URL
        # layout.add_widget(background_img)
        background_img = Image(source="D:\balll\pic.gif", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_img)
